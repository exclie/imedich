 ...
 */
class Tiposestudio extends \CsnUser\Entity\Tiposestudio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'ID', 'NOMBRECATEGORIA', 'COSTO');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tiposestudio $proxy) {
