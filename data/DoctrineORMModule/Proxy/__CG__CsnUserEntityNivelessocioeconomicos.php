 ...
 */
class Nivelessocioeconomicos extends \CsnUser\Entity\Nivelessocioeconomicos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nivelessocioeconomicos $proxy) {
